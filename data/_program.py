...
from data.functions import _Function
from data.utils.gp_utils import check_random_state
...
class _Program(object):
    ...
    # fitness function relativa a D-CODE, sata sulla variational formulation dell'ODE
    def raw_fitness(self, X, y, sample_weight, sample_weight2, ode_data):
        ...
        y_hat_long = self.execute(x_hat_long) # idea: tramite la funzione execute, la guess corrente della funzione f viene valutata sui dati x_hat ottenendo i corrsipondenti y_hat, ossia i valori della derivata
        # T, B
