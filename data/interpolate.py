...
from data.tvregdiff.tvregdiff import TVRegDiff
import data.gppca
from data.config import get_interpolation_config
from data.integrate import generate_grid
...
def num_dff_tuning(yt, dg, alg, T0=0):
    yt0 = dg.xt[T0*dg.freq:, :, :]
    aux = dg.solver.t[T0*dg.freq:]
