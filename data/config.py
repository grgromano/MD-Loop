...
def get_config(ode, x_id=0):
    ...
    elif ode.name == 'SelkovODE' or ode.name == 'SelkovODE_rho' or ode.name == 'SelkovODE_sigma' or ode.name == 'SelkovODE_rho_03' or ode.name == 'SelkovODE_rho_04' or ode.name == 'SelkovODE_rho_06' or ode.name == 'SelkovODE_rho_09' or ode.name == 'OscillatingSelkovODE':
...
# RMK. SR-T ha bisogno di 'parsimony_coefficient': 0.001 (tove), con D-CODE invece 'parsimony_coefficient': 0.01 -> bisogna cambiarlo ogni volta!!!
selkov_config = {'population_size': 30000,
                   ...
                   'max_samples': 0.9,
                   'verbose': 1,
                   'parsimony_coefficient': 0.001, #0.01, #0.001 -> bloat, 'auto' -> pessimo,
                   'init_depth': (1, 6),
                   'n_jobs': 2,
                   'low_memory': True
                   }
...
oscillating_logistic_config = {'population_size': 15000,
                   ...
                   'p_hoist_mutation': 0.0361,
                   'p_point_mutation': 0.0905,
                   'function_set': {'sub': 1, 'mul': 1, 'pow': 1, 'add': 1, 'neg': 1, 'sin': 1},
                   'const_range': (0.01, 7.), # !!!
                   'generations': 20,
                   'stopping_criteria': 0.01,
                   'max_samples': 0.9,
